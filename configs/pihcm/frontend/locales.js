...
const locales = [
  {
    ...
    translations: [
      ...
      { key: "dengue", value: "Bệnh sốt xuất huyết" },
      {
        ...
        value: "Số ca mắc SXHD KVPN theo tuần 5 năm liền kề",
      },
      { key: "legendWidget1DengueDashboard", value: "{{year}}" },
      {
        key: "widget2DengueDashboardTitle",
        value: "Số ca tử vong do SXHD cộng dồn theo tuần 5 năm liền kề",
      },
      { key: "legendWidget2DengueDashboard", value: "{{year}}" },
      {
        key: "widget3DengueDashboardTitle",
        value: "Số ca mắc SXHD và tử vong do SXHD phân bố theo địa phương",
      },
      { key: "selectYear", value: "Chọn năm" },
      { key: "selectUnit", value: "Chọn đơn vị" },
      {
        key: "widget4DengueDashboardTitle",
        value: "Số ca mắc SXHD theo nhóm tuổi",
      },
      {
        key: "widget5DengueDashboardTitle",
        value: "Số ca tử vong do SXHD theo nhóm tuổi",
      },
      {
        key: "widget6DengueDashboardTitle",
        value: "Số ca mắc SXHD phân bố theo nhóm tuổi và địa phương",
      },
      {
        key: "widget7DengueDashboardTitle",
        value: "Số ca mắc SXHD theo độ nặng ca bệnh",
      },
      {
        key: "widget8DengueDashboardTitle",
        value: "Số ca mắc SXHD theo độ nặng ca bệnh và địa phương",
      },
