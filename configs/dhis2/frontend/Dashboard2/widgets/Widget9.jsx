    ...
    useEffect(() => {
        (async () => {
            ...
            const result = await axios.get("/api/last12WeeksData", {
                params: {
                    dx: ["ALGGO6Fzsmk", "klqZCNLDJeg", "UfMQFhnIdyx", "NCATB7tMvXz", "oB2V0av7Nld", "lGhEix4QsDl", "bsxH7MtmJQq"].join(";"),
                    ou: orgUnit.id,
            ...
            setData({
                ...
                datasets: ["ALGGO6Fzsmk", "klqZCNLDJeg", "UfMQFhnIdyx", "NCATB7tMvXz", "oB2V0av7Nld", "lGhEix4QsDl", "bsxH7MtmJQq"].map((piId, index) => ({
