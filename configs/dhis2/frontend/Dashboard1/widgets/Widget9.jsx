    ...
    useEffect(() => {
        (async () => {
            ...
            const result = await axios.get("/api/last12WeeksData", {
                params: {
                    dx: ["fndeTSCzksd", "XanEiS1nUsd", "H3pKakrWpVP", "GqjGeB7C3TC", "jmz6aS32VN6", "EfsZx99m5AA", "jMWGo4BFaWk"].join(";"),
                    ou: orgUnit.id,
            ...
            setData({
                ...
                datasets: ["fndeTSCzksd", "XanEiS1nUsd", "H3pKakrWpVP", "GqjGeB7C3TC", "jmz6aS32VN6", "EfsZx99m5AA", "jMWGo4BFaWk"].map((piId, index) => ({
