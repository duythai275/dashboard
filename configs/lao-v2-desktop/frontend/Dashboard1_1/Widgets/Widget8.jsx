...
import { WIDGET_8_DASHBOARD_1_COLORS } from "../common/constant/color";
...
const Widget8 = ({ setLoading, dataItemId }) => {
    ...
    if (additionalState.widget456Dashboard1Ready) {
      ...
      listTargetPe.forEach((pe) => {
        ...
        pe.months.forEach((month) => {
          const findData = additionalState.widget456Dashboard1Data.rows.find(
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const colors = WIDGET_8_DASHBOARD_1_COLORS;
      let currentData = {};
