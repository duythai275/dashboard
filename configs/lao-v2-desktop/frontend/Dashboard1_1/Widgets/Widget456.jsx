...
const Widget456 = ({ setLoading, dataItemId }) => {
  ...
  useEffect(() => {
    if (additionalState.widget456Dashboard1Ready) {
      const response = {};
      response.data = additionalState.widget456Dashboard1Data.rows
    ...
    setLoading(!additionalState.widget456Dashboard1Ready);
  }, [additionalState.widget456Dashboard1Ready]);
...
export default withWidgetChildrenLoader(Widget456);
