...
import { WIDGET_7_DASHBOARD_1_COLORS } from "../common/constant/color";
...
const Widget7 = ({ setLoading, dataItemId }) => {
    ...
    if (additionalState.widget123Dashboard1Ready) {
      ...
      listTargetPe.forEach((pe) => {
        ...
        pe.months.forEach((month) => {
          const findData = additionalState.widget123Dashboard1Data.rows.filter(
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const colors = WIDGET_7_DASHBOARD_1_COLORS;
      let currentData = {};
