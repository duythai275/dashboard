...
import { WIDGET_9_DASHBOARD_3_LEGEND_COLORS } from "../common/constant/color";

const Widget9 = ({ setLoading, dataItemId }) => {
  ...
  const legend = WIDGET_9_DASHBOARD_3_LEGEND_COLORS;
