...
import { WIDGET_4_DASHBOARD_1_DATA_ITEMS } from "../common/constant/dataItem";
import { WIDGET_4_DASHBOARD_1_COLORS } from "../common/constant/color";
...
const Widget4 = ({ setLoading }) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const dataItems = WIDGET_4_DASHBOARD_1_DATA_ITEMS.map((de) => {
        const foundDi = hmisDataItems.find((di) => di.id === de);
        return foundDi;
      });
      const colors = WIDGET_4_DASHBOARD_1_COLORS;
      let currentData = {};
