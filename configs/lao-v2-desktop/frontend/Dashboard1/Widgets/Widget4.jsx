...
const Widget4 = ({ setLoading }) => {
  const { hmisDataItems } = useMetadataStore((state) => ({ hmisDataItems: state.hmisDataItems }), shallow);
  ...
  useEffect(() => {
    ...
    setLoading(additionalState.widget4567Ready ? false : true);
    ...
    // setLoading(false);
    // })();
  }, [additionalState.widget4567Ready]);
