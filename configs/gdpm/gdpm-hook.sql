...
from analytics_event_po07dgbjcgr aepd 
...
drop table if exists _analytics_casereporting_cases_country;
create table _analytics_casereporting_cases_country as
...
drop table if exists _analytics_casereporting_deaths_country;
create table _analytics_casereporting_deaths_country as
